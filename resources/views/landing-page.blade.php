        ...
        <div class="row py-5">
          <div class="col-lg-5 py-5">
            ...
            <ul class="list-inline mb-0">
              <li class="list-inline-item mb-2 mb-lg-0"><a class="btn btn-primary btn-lg px-4" href="#!">Daftar di Sini</a></li>
          ...
          <div class="col-lg-6 ml-auto">
            <div class="device-wrapper mx-auto">
              <div class="device shadow" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                <div class="screen"><img class="img-fluid" src="../assets/landing-page/img/mobile.png" alt=""></div>
              </div>
            </div>
          </div>
        </div>
